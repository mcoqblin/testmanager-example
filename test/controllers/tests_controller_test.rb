...
class TestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create test" do
    assert_difference('Test.count') do
      post tests_url, params: { test: { feature_id: @test.feature_id, name: @test.name, state: @test.state } }
    end
  ...
  test "should update test" do
    patch test_url(@test), params: { test: { feature_id: @test.feature_id, name: @test.name, state: @test.state } }
